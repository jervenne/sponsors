        ...
        <div class="row remove-margin">
            ...
            <div class="col-sm-6">
                ...
                <a href="" class="header-title-link">
                    <img src="img/template/avatar2.jpg" alt="Avatar" class="profile-photo animation-expandUp img-circle">
                    ...
                    <div class="col-xs-4">
                        <a href="javascript:void(0)" class="header-link">
                            <h1 class="animation-pullDown">
                                <strong>750</strong><br><small>Followers</small>
                            </h1>
                        </a>
                    </div>
                    <div class="col-xs-4">
                        <a href="javascript:void(0)" class="header-link">
                            <h1 class="animation-pullDown">
                                <strong>20</strong><br><small>Projects</small>
                            </h1>
                        </a>
                    </div>
                    <div class="col-xs-4">
                        <a href="javascript:void(0)" class="header-link">
                            <h1 class="animation-pullDown">
                                <strong>378</strong><br><small>Updates</small>
                            </h1>
                        </a>
                    </div>
                </div>
                ...
                <ul class="media-list">
                    <li class="media">
                        <a href="javascript:void(0)" class="pull-left">
                            <img src="img/template/avatar2.jpg" alt="Avatar" class="media-object img-circle" width="50" height="50">
                        </a>
                        <div class="media-body">
                            ...
                            <div class="media">
                                <a href="javascript:void(0)" class="pull-left">
                                    <img src="img/template/avatar.png" alt="Avatar" class="media-object img-circle">
                                </a>
                                <div class="media-body">
