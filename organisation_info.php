...
<div id="page-content" class="block">
        ...
        <div class="row remove-margin">
            ...
            <div class="col-md-4">
                ...
                <a href="" class="header-title-link">
                    <h1><i class="fa fa-coffee animation-expandUp"></i>Hall 11<br><small>Welcome admin!</small></h1>
                </a>
            </div>
            <!-- END Title -->
                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <a href="page_special_timeline.php" class="header-link">
                                    <h1 class="animation-pullDown">
                                        <strong>0</strong><br><small>Events</small>
                                    </h1>
                                </a>
                            </div>
                            <div class="col-xs-6">
    ...
    <div class="row gutter30">
        ...
        <div class="col-md-6">
            ...
            <div class="block full">
                <div class="block-title">
                    <h2 class="text-center"><i class="gi gi-charts"></i> Earnings / Sales <small>Last Week - <a href="page_comp_charts.php">In detail</a></small></h2>
                </div>
