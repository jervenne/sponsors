            ...
            <div id="page-content" class="block remove-margin">
                ...
                <div class="block-header">
                    <div class="header-section">
                        <h1 class="text-center">Welcome to <?php echo $template['name']; ?><br><small>Please Login or Register</small></h1>
                    </div>
                </div>
                <!-- END Login Title -->
                ...
                <!-- Register Form -->
                <form action="page_special_login.php" method="post" id="form-register" class="form-horizontal display-none" onsubmit="return false;">
                    <div class="form-group">
                        <div class="col-xs-12">
