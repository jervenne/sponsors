            ...
            <div class="tab-pane" id="search-tab-user">
                ...
                <div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <tr>
                                <td class="text-center"><img src="img/placeholders/image_64x64_light.png" class="img-circle" alt="photo"></td>
                            ...
                            <tr>
                                <td class="text-center"><img src="img/placeholders/image_64x64_dark.png" class="img-circle" alt="photo"></td>
                                <td><a href="page_special_user_profile.php">John Doe</a></td>
                                <td>username2</td>
                                <td><span class="label label-success">Active</span></td>
                                <td class="text-center">
