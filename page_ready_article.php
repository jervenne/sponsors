...
<div id="page-content" class="block">
    ...
    <div class="block-header">
        ...
        <a href="" class="header-title-link">
            <h1>
                <i class="gi gi-pencil animation-expandUp"></i>Article<br><small>A subtitle would go here!</small>
            </h1>
        </a>
    </div>
                    ...
                    <div class="col-xs-6">
                        <p>
                            <a href="img/placeholders/image_720x450_light.png" data-toggle="lightbox-image">
                                <img src="img/placeholders/image_720x450_light.png" alt="fakeimg" class="img-responsive">
                            </a>
                        </p>
                    </div>
                    <div class="col-xs-6">
                ...
                <ul class="media-list">
                    <li class="media">
                        <a href="javascript:void(0)" class="pull-left">
                            <img src="img/placeholders/image_64x64_dark.png" alt="Avatar" class="media-object img-circle" width="50" height="50">
                        </a>
                    ...
                    <li class="media">
                        <a href="javascript:void(0)" class="pull-left">
                            <img src="img/placeholders/image_64x64_light.png" alt="Avatar" class="media-object img-circle" width="50" height="50">
                        </a>
                        <div class="media-body">
