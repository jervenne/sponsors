...
<div id="page-content" class="block full">
    ...
    <div class="block-header">
        ...
        <a href="" class="header-title-link">
            <h1>
                <i class="fa fa-thumbs-o-up animation-expandUp"></i>Datatables<br><small>Any static table can become fully dynamic with cool features such as pagination and instant search!</small>
            </h1>
        </a>
    </div>
