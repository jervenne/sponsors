...
<div id="page-content" class="block">
    ...
    <div class="block-header">
        ...
        <a href="" class="header-title-link">
            <h1>
                <i class="gi gi-comments animation-expandUp"></i>Forum<br><small>Ready to use UI to create your forum!</small>
            </h1>
        </a>
    </div>
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="forum-cats">
            ...
            <table class="table forum remove-margin">
                ...
                <tbody>
                    <tr>
                        <td class="cell-small text-center"><i class="gi gi-flag fa-2x themed-color"></i></td>
                        <td>
                    ...
                    <tr>
                        <td class="text-center"><i class="gi gi-pen fa-2x themed-color"></i></td>
                        <td>
            ...
            <table class="table forum remove-margin">
                ...
                <tbody>
                    <tr>
                        <td class="cell-small text-center"><i class="gi gi-brush fa-2x themed-color"></i></td>
                        <td>
                    ...
                    <tr>
                        <td class="text-center"><i class="gi gi-tint fa-2x themed-color"></i></td>
                        <td>
                    ...
                    <tr>
                        <td class="text-center"><i class="gi gi-embed_close fa-2x themed-color"></i></td>
                        <td>
                    ...
                    <tr>
                        <td class="text-center"><i class="gi gi-heart_empty fa-2x themed-color"></i></td>
                        <td>
                    ...
                    <tr>
                        <td class="text-center"><i class="gi gi-tower fa-2x themed-color"></i></td>
                        <td>
            ...
            <table class="table forum">
                ...
                <tbody>
                    <tr>
                        <td class="cell-small text-center"><i class="gi gi-circle_question_mark fa-2x themed-color"></i></td>
                        <td>
        ...
        <div class="tab-pane" id="forum-topics">
            ...
            <table class="table forum">
                ...
                <tbody>
                    <tr class="active">
                        <td class="text-center cell-small"><i class="gi gi-construction_cone fa-2x themed-color"></i></td>
                        <td>
                    ...
                    <tr class="active">
                        <td class="text-center"><i class="gi gi-construction_cone fa-2x themed-color"></i></td>
                        <td>
                            <h4><a href="javascript:void(0)">Topic Title</a> <br><small>by <a href="page_special_user_profile.php">admin</a>, September 20, 2013, 16:00</small></h4>
                        </td>
                        <td class="text-center hidden-xs hidden-sm"><a href="javascript:void(0)">25</a></td>
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="forum-avatar text-center">
                            <a href="page_special_user_profile.php"><img src="img/placeholders/image_64x64_dark.png" class="img-circle" alt="avatar"></a>
                    ...
                    <tr>
                        <td class="forum-avatar text-center">
                            <a href="page_special_user_profile.php"><img src="img/template/avatar2.jpg" class="img-circle" alt="avatar"></a>
                        </td>
                        <td class="forum-post">
